...
public class HW3 {
	...
	static String systemName = "Lucene";
	...
	IndexSearcher searcher = new IndexSearcher(reader);
		...
		String scoreDoc = "scoreDocLucene.txt";
	...
	s = "";
		...
		System.out.println("Enter the file which holds query:");
		...
		try (BufferedReader br2 = new BufferedReader(new FileReader(qf)))
		{
			...
			while ((sCurrentLine = br2.readLine()) != null) {
				...
				qm.put(Integer.parseInt(line[0]), line[1]);
			}
		...
		for (int i = 0; i < hits.length; ++i) {
			...
			bw.write(qe.getKey()+" "+"Q0"+" "+fn.getName()+" "+(i+1)+" "+hits[i].score+" "+systemName+"\n");
		}
	}
	bw.close();
