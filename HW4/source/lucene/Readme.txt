...
Note: Quries must be stored in the file in the following format,
	  Query_Id;Query
	  The absolute path of the file for quries must be given when asked during program execution.
-----------------------------------------------CODE--------------------------------------------------------------------------------
                                  ::::::::::::Lucene:::::::::::::::
